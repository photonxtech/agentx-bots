...
class SessionSummary(BaseModel):
    ...
    has_qa: bool = False
    # Whether the session has user-uploaded seed Q&A pairs.
    has_seed_qa: bool = False
...
class SessionDetail(BaseModel):
    ...
    # User-uploaded manually-created Q&A pairs (seed test set).
    seed_qa_json: Optional[Any] = None
